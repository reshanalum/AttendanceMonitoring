...
namespace AttendanceMonitoringSystem.ViewModel
{
    public class StudentListVM : NotifyPropertyChanged
    {
        ...
        public ObservableCollection<StudentInDisplay> StudentList { get; set; } = new ObservableCollection<StudentInDisplay>();
        ...
        private void RecalculateDisplayNumbers(List<StudentInDisplay> students)
        {
